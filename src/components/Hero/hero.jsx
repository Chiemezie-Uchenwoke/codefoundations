...
const Hero = () => {
    ...
    return (
        <section className="border border-borderColor py-8 md:py-12 lg:py-20 bg-[prim/3] relative before:content-[''] before:absolute before:w-full before:h-full before:bg-black/10 before:left-0 before:top-0 before:z-10 " style={{backgroundImage: `url(${bgImage})`}}>
