        ...
        <section className="border border-borderColor py-8 md:py-12 lg:py-16 bg-prim/3">
            <div className="container-custom flex flex-col gap-8 sm:flex-row">
                <div className="flex flex-col gap-6 w-[100%] md:w-[60%]">
                    <h1 className="font-medium text-shade-of-black capitalize text-[1.5rem] sm:text-lg md:text-2xl lg:text-[2.52rem] leading-10 lg:leading-16">Still Struggling With <span className="text-prim">JavaScript</span> or <span className="text-prim">Web Fundamentals</span>?</h1>
                    ...
                    <div className="flex flex-col md:flex-row gap-3 md:gap-4 my-2">
                ...
                <figure className="md:w-[40%] flex justify-center items-center">
                    <img src={illustration} alt="illustration" loading="lazy" className="w-full max-w-[25rem] sm:max-w-[35rem]" />
                </figure>
            </div>
        </section>
    )
